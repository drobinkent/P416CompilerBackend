...
p4program = p4ProgramParserFactory.getParsedP4Program(p4JsonFile="../Resources/curated_programs_for_paper/l2l3complex/l2l3complex.json",p4VersionAndArchitecture="P416_V1_Model")
