...
SPECIAL_KEY_FIELD_NAME_FOR_CARRYING_CODNDITIONAL_RESULT_IN_INGRESS_BIT_WIDTH = 8
...
SPECIAL_KEY_FIELD_NAME_FOR_CARRYING_CODNDITIONAL_RESULT_IN_EGRESS_BIT_WIDTH = 8