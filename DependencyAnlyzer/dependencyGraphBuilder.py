...
from P4ProgramParser.P416Bmv2JsonParser.P416JsonParser import Expression, ValueType, PrimitiveOpblock, PrimitiveField, \
    HexStr, PrimitiveHeader, BoolPrimitive, RegisterArrayPrimitive, PrimitiveOp, Action

sys.path.append("..")
import ConfigurationConstants as confConst
from DependencyAnlyzer.P4TEAnalyzer import MATNode
